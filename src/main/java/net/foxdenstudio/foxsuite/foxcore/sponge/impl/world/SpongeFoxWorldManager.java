package net.foxdenstudio.foxsuite.foxcore.sponge.impl.world;
...
public class SpongeFoxWorldManager extends FoxWorldManagerImplBase {
    ...
    public void onWorldLoad(LoadWorldEvent event) {
        ...
        foxWorld.setOnlineWorld((net.foxdenstudio.foxsuite.foxcore.platform.world.World) world);
        this.weakOnlineMap.put((net.foxdenstudio.foxsuite.foxcore.platform.world.World) world, foxWorld);
    }
