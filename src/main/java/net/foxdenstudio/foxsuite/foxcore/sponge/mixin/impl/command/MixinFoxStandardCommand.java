...
public interface MixinFoxStandardCommand extends CommandCallable {
    ...
    @Shadow
    FoxCommandResult process(net.foxdenstudio.foxsuite.foxcore.platform.command.source.CommandSource source,
    ...
    default CommandResult process(CommandSource source, String arguments) throws CommandException {
        ...
        try {
            result = this.process((net.foxdenstudio.foxsuite.foxcore.platform.command.source.CommandSource) source, arguments);
